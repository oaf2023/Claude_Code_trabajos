/**
 * Mobile Dev Agent — MCP Server
 * Herramientas que generan y escriben código mobile directamente en tu proyecto
 * Plataformas: iOS (Swift/SwiftUI) · Android (Kotlin/Compose) · Flutter · React Native/Expo
 */
...
// ── Directorio raíz del proyecto (donde está la carpeta mcp-server) ──
...
console.error(`📱 Mobile Dev Agent MCP Server iniciado`);
console.error(`📁 Proyecto: ${PROJECT_ROOT}`);
console.error(`🔧 Herramientas disponibles: create_code_file, create_project_structure, implement_native_feature, add_permissions, read_project_file, list_project_files, update_file_section`);
